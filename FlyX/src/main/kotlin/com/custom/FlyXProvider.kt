...
class FlyXProvider : MainAPI() {
    override var mainUrl = "https://tv.vynx.cc"
    override var name = "FlyX"
    ...
    private fun movieUrl(id: Int) = "$mainUrl/watch/movie/$id"
    private fun tvUrl(id: Int)    = "$mainUrl/watch/tv/$id"
    ...
    override suspend fun loadLinks(
        ...
        try {
            ...
            Log.e("FlyX", "Vidlink failed: ${ex.message}")
        }
