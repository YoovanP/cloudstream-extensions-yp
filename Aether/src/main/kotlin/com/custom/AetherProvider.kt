...
class AetherProvider : MainAPI() {
    override var mainUrl = "https://aether.mom"
    ...
    override suspend fun loadLinks(data: String, isCasting: Boolean, subtitleCallback: (SubtitleFile) -> Unit, callback: (ExtractorLink) -> Unit): Boolean {
        ...
        // Aether Internal Manifest Priority
        try {
            val type = if (s == null) "movie" else "tv"
            loadExtractor("https://tik.aether.mom/watch/$tmdbId", "$mainUrl/", subtitleCallback, callback)
        } catch (_: Exception) { }
