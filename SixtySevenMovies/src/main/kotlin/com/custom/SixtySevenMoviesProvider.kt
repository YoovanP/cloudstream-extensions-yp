...
class SixtySevenMoviesProvider : MainAPI() {
    override var mainUrl = "https://67movies.net"
    override var name = "SixtySevenMovies"
    ...
    override suspend fun loadLinks(
        ...
        try {
            ...
            Log.e("SixtySevenMovies", "Vidlink failed: ${ex.message}")
        }
