...
class FlixerProvider : MainAPI() {
    override var mainUrl = "https://flixer.su"
    override var name = "Flixer"
    ...
    private fun movieUrl(id: Int) = "$mainUrl/en/movie/$id"
    private fun tvUrl(id: Int)    = "$mainUrl/en/tv/$id"
    ...
    override suspend fun loadLinks(
        ...
        try {
            ...
            Log.e("Flixer", "Vidlink failed: ${ex.message}")
        }
